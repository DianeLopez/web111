...
.tv1-bg {
        background-image: url('tv1_bg.jpg'); 
    }
    
   .lightbuld1-bg {
        background-image: url('lightbuld1_bg.jpg');
    }
    /* Style for modal */
    .modal {
...
<div class="container">
    ...
    <div class="row">
        <!-- First Row -->
        <div class="object-container lightbuld1-bg"> 
            <div class="object-name">Light Buld</div>
            <div class="switch-container">
                <label class="switch">
                    <input id="lightbuld1Switch" type="checkbox">
                    <span class="slider"></span>
                </label>
            </div>
        </div>
        <!-- Add TV Appliance -->
     <div class="object-container tv1-bg">
            <div class="object-name">Television</div>
            <div class="switch-container">
                <label class="switch">
                    <input id="tv1Switch" type="checkbox">
                    <span class="slider"></span>
                </label>
            </div>
        </div>
...
addApplianceListeners('lightbuld1Switch');
addApplianceListeners('tv1Switch');
