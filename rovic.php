...
<style>
    ...
    .air-conditioner-bg {
        background-image: url('air_conditioner_bg.jpg'); /* Replace 'air_conditioner_bg.jpg' with your image path */
    }

   .tv-bg {
        background-image: url('tv_bg.jpg'); /* Add the image path for the TV background */
    }
...
<div class="container">
    ...
    <div class="row">
        ...
        <!-- Adding TV -->
          <div class="object-container tv-bg"> <!-- Modified class name to match background -->
...
addApplianceListeners('televisionSwitch'); // Add listener for TV
